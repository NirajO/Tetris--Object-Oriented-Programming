...
/* This is JayBrick subclass for TetrisBrick superclass
/* Niraj Ojha
...
{
   public JayBrick(int colorNum, int colNum)
    {
    ...
    public int[][] initPosition(int centerColumn)  
    {
        ...
        int[][]brickPosition = new int[][]{{0, initialCol + 1}, {1, initialCol + 1},
                                           {2, initialCol + 1}, {2, initialCol}};
