...
/* This is ElBrick subclass for TetrisBrick superclass
/* Niraj Ojha
...
{
    public ElBrick(int colorNum, int colNum)
    {
    ...
    public int[][] initPosition(int centerColumn)
    {
        ...
        int[][] brickPosition = new int [][]{{0, initialCol}, {1, initialCol}, 
                                 {2, initialCol}, {2, initialCol + 1}};
