...
/*This is EssBrick subclass for TetrisBrick superclass
/* Niraj Ojha
...
{
    public EssBrick(int colorNum, int colNum)
    {
    ...
    public int[][] initPosition(int centerColumn)
    {
        ...
        int[][] brickPosition = new int[][] {{0, initialCol+1}, {0, initialCol + 2},
        {1, initialCol}, {1, initialCol + 1}};
